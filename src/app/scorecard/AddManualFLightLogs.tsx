  ...
  return apiResponse ? (
    ...
    <div className="px-8 py-8 w-full h-full bg-white">
      ...
      <h4 className="text-xl font-semibold mb-4 text-black pt-10">
        1. Please click on the previews below for examples on how to frame your flight log image
      </h4>
      <h4 className="text-xl font-semibold mb-4 text-black">
        2. You can upload as many logs as needed but for accuracy purposes, we recommend to sort the images in
        chronological order and grouping them by file type.
      </h4>
      <h4 className="text-xl font-semibold mb-4 text-black">
        3. The limit is 10 files at no greater than 15 MB each. PDF files should also not exceed 15 MB.
      </h4>
      <div className="flex pt-20 px-10 gap-20">
        <div className="flex flex-col justify-center items-center w-fit">
          ...
          <Button
            type="button"
            onClick={() => {
              setActiveImage("/scorecard/example-manual1.png");
              setPreviewOpen(true);
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <Button
            type="button"
            onClick={() => {
              setActiveImage("/scorecard/example-manual2.png");
              setPreviewOpen(true);
              if (!previewButtonRef.current) return;
              previewButtonRef.current.click();
            }}
...
export default AddManualFlights;
